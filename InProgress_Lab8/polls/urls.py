...
urlpatterns = [
    ...
    path('osobas/', views.osoba_list, name='osobas_list'),
    ...
    path('stanowiskos/', views.stanowisko_list, name='stanowiskos_list'),
    path('stanowiskos/add/', views.stanowisko_add),
    path('stanowisko/<int:pk>/members', views.StanowiskoMembers.as_view(), name='StanowiskoList'),
